...
// params 参数 是在url中携带的，属于路径一部分
// query参数， 可以在url中携带 ？分割，后面就是query参数
              //也可以在配置对象中配置，配置的属性名叫params！！！
// 请求体参数， 在配置对象当中的data里面配置， 请求方式是put和post才有请求体参数

//函数写法：
// axios({
//   url: 'localhost:8080/userinfo/1?name=why',
//   method:,
//   params: {
//     //代表的是query参数
//     name: 'why'
...
//请求三级分类列表数据，请求typenav数据，就调用该函数即可
//get 
//api/product/getBaseCategoryList
//无参

export const reqCategoryList = () => {  //接口请求函数
  return request({
